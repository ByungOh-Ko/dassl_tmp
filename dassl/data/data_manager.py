...
from .datasets import build_dataset, Datum, DatumWithBbox
...
def build_data_loader(
    ...
    if dataset_wrapper is None:
        if isinstance(data_source[0], Datum):
            dataset_wrapper = DatasetWrapper
        elif isinstance(data_source[0], DatumWithBbox):
            dataset_wrapper = DatasetWrapper_Bbox
...
class DatasetWrapper_Bbox(TorchDataset):
